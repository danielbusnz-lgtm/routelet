...
synthetic pool in data/, evaluates on the hand-written seed in examples/, which
were generated by different processes so the eval isn't just memorized train.
"""
